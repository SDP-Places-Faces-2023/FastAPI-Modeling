...
def main():
    ...
    checkpointer = tf.keras.callbacks.ModelCheckpoint(filepath='face_recognition_scratch.h5', verbose=1, save_best_only=True)
    ...
    joblib.dump(label_encoder, "label_encoder_scratch.joblib")
